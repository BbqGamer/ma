...
def main(
    ...
    num_blocks: int = typer.Option(1, help="Residual blocks for Fourier/MLP models."),
    num_fourier: int = typer.Option(16, help="Number of Fourier features for Fourier models."),
