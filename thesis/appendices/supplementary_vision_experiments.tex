...
44 and added adaptive plateau schedules under a 200-epoch budget. The adaptive
rule advanced from a coarse stage when fine-label validation accuracy stopped
improving after a minimum stage length or when a maximum stage length was
reached. Two hierarchy
