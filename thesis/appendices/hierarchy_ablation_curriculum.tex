...
\begin{tabular}{lrrrr}
\hline
Condition & Best acc. & Best gain & Final acc. & Trajectory-AUC gain \\
\hline
Baseline & 35.29 & -- & 32.01 & -- \\
Learned hierarchy & 37.53 & +2.24 & 32.75 & -3.85 \\
Random hierarchy mean & 35.81 & +0.53 & 31.75 & -5.40 \\
...
averages across seeds. Final accuracy is final-epoch test accuracy; trajectory
AUC is computed separately over the test-accuracy trajectory.}
...
hierarchy improves it by only +0.53 points. The learned hierarchy outperforms
the random mean for all three training seeds. Even the best of the three random
...
\begin{figure}[h]
    ...
    hierarchy outperforms both the random mean and the best-of-three random diagnostic.}
...
3.85 percentage points below baseline, and the random-hierarchy AUC is 5.40
...
Appendix~\ref{app:roughness-followup-curriculum}. The scale of the effect is
consistent across the two comparisons.
