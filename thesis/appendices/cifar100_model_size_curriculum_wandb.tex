...
This appendix summarizes the first CIFAR-100 \cite{krizhevsky2009learning}
model-size study for the coarse-to-fine curriculum learning reproduction. The
main question was whether the curriculum remains useful as the model becomes
larger or architecturally stronger. A secondary goal was to check whether
macro-F1, top-5 accuracy, hierarchy-aware scores, and calibration tell the same
story as top-1 accuracy.
...
\begin{itemize}
    \item dataset: CIFAR-100 \cite{krizhevsky2009learning},
    \item seed: 42,
...
baseline and five curriculum runs tracked in Weights \& Biases
\cite{biewald2020experiment}. The omitted length 50 was intentionally not used
in this study, because earlier runs suggested that very long hard curricula
...
\begin{itemize}
    ...
    \item CIFAR-style ResNets with depths 8, 20, 32, and 56 \cite{he2016deep},
...
\hline
Model & Params & Base & Best curr. & Curr. acc. & Gain & AUC gain \\
\hline
