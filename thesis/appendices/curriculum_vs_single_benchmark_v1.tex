...
\chapter{Curriculum versus single benchmark v1}
...
\bottomrule
\end{tabular}
\caption{Lower-loss and lower-runtime counts by regime.}
\label{tab:curr-vs-single-counts}
\end{table}
...
\begin{tabular}{llll}
\toprule
Function & equal\_epochs & equal\_time & Lower runtime \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Function-level lower-loss method by regime.}
\label{tab:curr-vs-single-function-counts}
\end{table}
...
In this benchmark, curriculum never achieved lower runtime.
